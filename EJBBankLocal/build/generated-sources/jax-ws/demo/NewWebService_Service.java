 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://demo/", wsdlLocation = "http://localhost:8080/EJBBank-war/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://demo/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EJBBank-war/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://demo/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo/", "NewWebServicePort"), NewWebService.class, features);
    }
